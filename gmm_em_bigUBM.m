function gmm = gmm_em_bigUBM( nmix, final_niter, ds_factor, nworkers,nnn,MainPath, gmmFilename)
...
NFRMS=0;GM=0;GV=0;
for part=1:nparts
      UBM_DataFile = strcat(MainPath, 'UBM\Data\UbmData2048new-',num2str(part),'.mat');
...
function [gm, gv,nframes] = comp_gm_gv(data)
