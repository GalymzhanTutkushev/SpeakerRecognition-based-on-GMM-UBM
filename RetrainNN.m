...
%         net = patternnet(hiddenLayerSize, trainFcn);
    ...
    figure, ploterrhist(e)
        ...
        sumErrDo(i)=numel(find(abs(e)==1))/length(e)*100;
        posErrDo(i)=numel(find(e==1))/length(e)*100;
        negErrDo(i)=numel(find(e==-1))/length(e)*100;
        ...
        percentErrors = sum(tind ~= yind)/numel(tind);
        toc
        sumErrPosle(i)=numel(find(abs(e)==1))/length(e)*100;
        posErrPosle(i)=numel(find(e==1))/length(e)*100;
        negErrPosle(i)=numel(find(e==-1))/length(e)*100;
